...
export class QuestionService {
  ...
  createQuestion(question_id:string,course_id: string, title: string, answerA: string, answerB: string,
    answerC: string, answerD: string, correctAnswer: string) {
    return this.http.post ('/api/question/create',
    {question_id:question_id, course_id: course_id, title: title, answerA: answerA, answerB: answerB,
